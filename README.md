...
* `CORPORATE_DATA_INGESTION_USE_SPLIT_INPUTS_OVERRIDE` -> if passed in, the inputs to CDL will be generated once for all topics and then passed to CDL, rather than CDL doing it for every topic (default is false)
